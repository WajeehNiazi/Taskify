...
const ICONS = {
  alert: (
    <HiBellAlert className='h-5 w-5 text-grey-600 group-hover:text-indigo-600' />
  ),
  message: (
    <BiSolidMessageRounded className='h-5 w-5 text-grey-600 group-hover:text-indigo-600' />
  ),
}
